...
{
	//var red = prompt("Ingrese el código de la red:", "red");
	var red = '{"neurons":[2,2,1],"weights":[0.07357162788663052,-1.214991665081172,-0.840793665422281,-0.31354608752541724,0.5938345525168165,-0.6440459426404286]}'; 
	game.gen[0].setSave(JSON.parse(red));
	game.birds[0].alive = true;
}
